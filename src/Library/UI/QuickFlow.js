...
(function(KUBE){
	...
	KUBE.LoadFactory('/Library/UI/QuickFlow',QuickFlow,['/Library/DOM/DomJack','/Library/DOM/StyleJack','/Library/Extend/Object','/Library/Extend/Array']);
	...
	function QuickFlow(viewHeight,itemHeight,ItemMap,mapArray,Target){
        ...
        function calcScrollBar(){
            var scroll = KUBE.Class('/Library/DOM/DomJack')(document.body).GetScrollBarDimensions();
            var event = {};
