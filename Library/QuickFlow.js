(function(KUBE){
	"use strict";
	KUBE.LoadFactory('/Library/QuickFlow',QuickFlow,['/Library/DomJack','/Library/StyleJack','/Library/ExtendObject','/Library/ExtendArray']);
	...
	function QuickFlow(viewHeight,itemHeight,ItemMap,mapArray,Target){
        ...
        function calcScrollBar(){
            var scroll = KUBE.Class('/Library/DomJack')(document.body).GetScrollBarDimensions();
            var event = {};
